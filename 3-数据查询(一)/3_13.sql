...
from
    ...
    union
    select c_name, c_id_card, c_id, (sum(i_amount * pro_quantity) + sum(pro_income)) as amount
    ...
    union
    select c_name, c_id_card, c_id, (sum(f_amount * pro_quantity) + sum(pro_income)) as amount
